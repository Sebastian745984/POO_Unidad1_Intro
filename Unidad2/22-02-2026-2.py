...
def realizar_prestamo():
    ...
    if not estudiante:
        print("Estudiante no encontrado")
        return
    libro = next ((l for l in libros if i.isbn == isbn), None)
    if not libro:
        print("Libro no encontrado")
        return
    if libro.prestado:
